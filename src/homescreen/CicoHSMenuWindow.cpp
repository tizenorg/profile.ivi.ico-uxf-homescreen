...
CicoHSMenuWindow::CicoHSMenuWindow(void)
{
    ...
    if (config.ConfigGetString("homescreen", "menu", "transparent",
                               menu_img_path, sizeof(menu_img_path)) == 0)  {
        if (strcmp(menu_img_path, "transparent") != 0)  {
...
CicoHSMenuWindow::SetAppTiles(void)
{
    ...
    const char *category_path = tzplatform_mkpath4(TZ_USER_HOME, ICO_HS_CONFIG_TOP,
                                                   ICO_HS_CONFIG_HOMESCREEN,
