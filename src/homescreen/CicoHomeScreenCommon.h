...
/*path of homescreen configuration*/
#define ICO_HS_CONFIG_TOP           "ico"
...
#define ICO_HS_DEFAULT_MENU_CATEGORY_FILE_PATH  ICO_SYC_PACKAGE_HOMESCREEN "/res/config/menu_categoryid.conf"

/*path of back window*/
#define ICO_HS_DEFAULT_BACK_WINDOW_IMAGE_FILE_PATH "/opt/usr/media/Images/Home_default.jpg"
