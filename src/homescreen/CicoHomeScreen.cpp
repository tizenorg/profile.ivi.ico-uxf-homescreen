...
CicoHomeScreen::ChangeZone(void)
{
    ...
    animation.name = (char*)ICO_HS_ANIMATION_FADE;
    animation.time = ICO_HS_ANIMATION_DURATION;
    ico_syc_move(wininfo->appid, wininfo->surface, &move, &animation);

    if (NULL == strstr(dispzone, "Mid")) {
